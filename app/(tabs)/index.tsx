    ...
    useEffect(() => {
        const loadCachedLocation = async () => {
            try {
                ...
                const cachedRecents = await AsyncStorage.getItem("recent_areas");
...
const styles = StyleSheet.create({
    ...
    serviceBigCard: {
        width: Math.floor((width - 32 - 40 - 16) / 3),
        alignItems: 'center',
    ...
    bookingLeft: { flex: 1 },
    bookingTag: { backgroundColor: '#F0FDF4', alignSelf: 'flex-start', paddingHorizontal: 14, paddingVertical: 8, borderRadius: 16, marginBottom: 14 },
    bookingTagText: { color: '#10B981', fontSize: 10, fontWeight: '900', textTransform: 'uppercase', letterSpacing: 0.5 },
    bookingTitle: { fontSize: 24, fontWeight: '900', color: '#0F172A', marginBottom: 8, letterSpacing: -0.2 },
    bookingInfoRow: { flexDirection: 'row', alignItems: 'center', gap: 8, marginBottom: 20 },
    bookingSub: { fontSize: 14, color: '#64748B', fontWeight: '600' },
    trackBtn: { 
        backgroundColor: '#0B3370', 
        paddingHorizontal: 20, 
        paddingVertical: 12, 
    ...
    trackText: { color: '#fff', fontWeight: '900', fontSize: 13, letterSpacing: 0.2 },
